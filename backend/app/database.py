...
TOOL_PERMISSIONS = ["dashboard", "lead_search", "lead_search_history", "business_search", "business_search_history", "outreach", "work_assignments", "data_library", "data_analytics", "used_oil_india", "exports", "settings"]
